...
Tại bước này, nhóm sử dụng công cụ \textbf{Google Vision API} để thực hiện hai nhiệm vụ chính:
\begin{enumerate}
...
\begin{itemize}
    \item \textbf{rec\_gt.txt}: Chứa ánh xạ giữa đường dẫn ảnh crop và văn bản nhận dạng tương ứng.
    \item \textbf{Label.txt}: Chứa tọa độ bounding box dưới dạng 4 điểm (top-left, top-right, bottom-right, bottom-left).
\end{itemize}

\textbf{Ví dụ minh họa cấu trúc file rec\_gt.txt:}
\begin{lstlisting}[basicstyle=\ttfamily\footnotesize]
fi/p0143_020.jpg    Ban Van co Dai hanh khien va Hanh khien 5 dao dung dau, sau
fi/p0143_021.jpg    cung co lay chuc Boc xa la Hanh khien. Thu den Thuong thu dung
fi/p0143_022.jpg    dau bo. Phan Huy Chu cho rang: "Bay gio moi dat hai bo la Lai bo,
fi/p0143_023.jpg    Le bo; thuoc quan co Lang trung, Vien ngoai lang, Chu su".
\end{lstlisting}

\textbf{Ví dụ minh họa cấu trúc file Label.txt:}
\begin{lstlisting}[basicstyle=\ttfamily\footnotesize]
fi/p0449_026.jpg    [[186, 4891], [3842, 4891], [3842, 5058], [186, 5058]]
fi/p0449_027.jpg    [[196, 5089], [1586, 5089], [1586, 5221], [196, 5221]]
fi/p0449_028.jpg    [[407, 5303], [3842, 5303], [3842, 5456], [407, 5456]]
fi/p0449_029.jpg    [[196, 5467], [3837, 5467], [3837, 5630], [196, 5630]]
\end{lstlisting}
